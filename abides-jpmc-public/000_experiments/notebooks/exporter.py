...
fig_executed_order.update_yaxes(title_font=dict(size=40, color="#0d0d0d", family="Times New Roman"))
fig_executed_order_qty.update_yaxes(title_font=dict(size=40, color="#0d0d0d", family="Times New Roman"))
fig_exchange_volume.update_yaxes(title_font=dict(size=40, color="#0d0d0d", family="Times New Roman"))
Ex_0_fig.update_yaxes(title_font=dict(size=40, color="#0d0d0d", family="Times New Roman"))
fig_exchange_turnover.update_yaxes(title_font=dict(size=40, color="#0d0d0d", family="Times New Roman"))
fig_spreads.update_yaxes(title_font=dict(size=40, color="#0d0d0d", family="Times New Roman"))
