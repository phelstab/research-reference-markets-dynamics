...
Ex_0_fig.update_layout(title="Time Series - exchange 0 (fixed fees)", yaxis_title='Price', yaxis_range=[995, 1005], template=custom_template_chart,width=450,height=170,)
...
Ex_1_fig.update_layout(title="Time Series - exchange 1 (maker taker)", yaxis_title='Price', yaxis_range=[995, 1005], template=custom_template_chart,width=450,height=170,)
...
fig_executed_order.update_layout(title="Cumulated Traded Securities (quantity of securities)", template=custom_template_executed_order,width=450,height=170, xaxis = dict(ticks='outside',showgrid=True, mirror=True,showline=True, tickfont=dict(size=9)),)
fig_executed_order_qty.update_layout(title="Cumulated Orders (quantity of orders)", template=custom_template_executed_order,width=450,height=170, xaxis = dict(ticks='outside',showgrid=True, mirror=True,showline=True, tickfont=dict(size=9)),)
fig_exchange_turnover.update_layout(title="Cumulated Turnover (fees in $)", template=custom_template_executed_order,width=450,height=170, xaxis = dict(ticks='outside',showgrid=True, mirror=True,showline=True, tickfont=dict(size=9)),)
fig_exchange_volume.update_layout(title="Cumulated Executed Order Volume (fill_price x fill_size in $)", template=custom_template_executed_order,width=450,height=170, xaxis = dict(ticks='outside',showgrid=True, mirror=True,showline=True, tickfont=dict(size=9)))
...
ex_0_fig_spreads.update_layout( template=custom_template,width=450,height=170)
...
ex_1_fig_spreads.update_layout( template=custom_template,width=450,height=170)
"""
...
ex_0_fig_speed.update_layout(title="Speed Of Executions (in milliseconds) - exchange 0",  template=custom_template_speed_fill_rate,width=450,height=170,)
...
ex_1_fig_speed.update_layout(title="Speed Of Executions (in milliseconds) - exchange 1",  template=custom_template_speed_fill_rate,width=450,height=170,)
...
ex_0_fig_fill_rate.update_layout(title="Fill Rate Of Executions (in %) - exchange 0", template=custom_template_speed_fill_rate,width=450,height=170,)
...
ex_1_fig_fill_rate.update_layout(title="Fill Rate Of Executions (in %) - exchange 1", template=custom_template_speed_fill_rate,width=450,height=170,)
...
# export pdfs
get_treemap_fig().write_image("dual_1337_fee_treemap.pdf", engine="kaleido")
Ex_0_fig.write_image("dual_1337_fee_timeseries0.pdf", engine="kaleido")
Ex_1_fig.write_image("dual_1337_fee_timeseries1.pdf", engine="kaleido")
fig_executed_order_qty.write_image("dual_1337_fee_executed_order_qty.pdf", engine="kaleido") #fehlt eventuell
fig_executed_order.write_image("dual_1337_fee_executed_order.pdf", engine="kaleido")
fig_exchange_volume.write_image("dual_1337_fee_executed_volume.pdf", engine="kaleido")
ex_0_fig_spreads.write_image("dual_1337_fee_spreads0.pdf", engine="kaleido")
ex_1_fig_spreads.write_image("dual_1337_fee_spreads1.pdf", engine="kaleido")
fig_exchange_turnover.write_image("dual_1337_fee_turnover.pdf", engine="kaleido")
ex_0_fig_speed.write_image("dual_1337_fee_speed0.pdf", engine="kaleido")
ex_1_fig_speed.write_image("dual_1337_fee_speed1.pdf", engine="kaleido")
ex_0_fig_fill_rate.write_image("dual_1337_fee_fillrate0.pdf", engine="kaleido")
ex_1_fig_fill_rate.write_image("dual_1337_fee_fillrate1.pdf", engine="kaleido")
app._favicon = ('icon.ico')

# app.run_server(debug=False)
# get last transacted trading volume
ex_0_last_volume = ex_0_executed_orders['cumsum_volume'].iloc[-1]
# get last quantity of executed orders
ex_0_last_qty = ex_0_executed_orders['cumsum_order_qty'].iloc[-1]
# get last quantity of executed securites
ex_0_last_qty_securities = ex_0_executed_orders['cumsum_qty'].iloc[-1]
# get last of order fees
ex_0_last_order_fee = ex_0_executed_orders['cumsum_order_fee'].iloc[-1]
# app.run_server(debug=False)
# get last transacted trading volume
ex_1_last_volume = ex_1_executed_orders['cumsum_volume'].iloc[-1]
# get last quantity of executed orders
ex_1_last_qty = ex_1_executed_orders['cumsum_order_qty'].iloc[-1]
# get last quantity of executed securites
ex_1_last_qty_securities = ex_1_executed_orders['cumsum_qty'].iloc[-1]
# get last of order fees
ex_1_last_order_fee = ex_1_executed_orders['cumsum_order_fee'].iloc[-1]

# create txt with averages
with open("./dual_fee_" + str(1337) + "_averages.txt", "w") as text_file:
    text_file.write("Exchange 0"+ "\n")

    text_file.write("Market close transacted trading volume" + str(ex_0_last_volume)+ "\n")
    text_file.write("Market close Quantity of executed orders" + str(ex_0_last_qty)+ "\n")
    text_file.write("Market close quantity of executed securites" + str(ex_0_last_qty_securities)+ "\n")
    text_file.write("Market close market fees turnover" + str(ex_0_last_order_fee)+ "\n")
    ...
    text_file.write("Exchange 1"+ "\n")

    text_file.write("Market close transacted trading volume" + str(ex_1_last_volume)+ "\n")
    text_file.write("Market close Quantity of executed orders" + str(ex_1_last_qty)+ "\n")
    text_file.write("Market close quantity of executed securites" + str(ex_1_last_qty_securities)+ "\n")
    text_file.write("Market close market fees turnover" + str(ex_1_last_order_fee)+ "\n")

    text_file.write(ex_1_average_speed_of_fill+ "\n")
    text_file.write(ex_1_average_fill_rate+ "\n")
    text_file.write(ex_1_average_quoted_spreads+ "\n")
    text_file.write(ex_1_average_effective_spreads+ "\n")
    text_file.write(ex_1_average_realized_spreads + "\n")