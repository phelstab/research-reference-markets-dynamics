...
Ex_0_fig = go.Figure()
Ex_0_fig.add_trace(go.Scatter(x=Ex0_best_bids["time"], y=Ex0_best_bids["price"], mode='lines', name='best_bids'))
Ex_0_fig.add_trace(go.Scatter(x=Ex0_best_bids["time"], y=Ex0_best_asks["price"], mode='lines', name='best_asks'))
Ex_0_fig.update_layout(title='Order book of Exchange 0', xaxis_title='Time', yaxis_title='Price')
Ex_1_fig = go.Figure()
Ex_1_fig.add_trace(go.Scatter(x=Ex1_best_bids["time"], y=Ex1_best_bids["price"], mode='lines', name='best_bids'))
Ex_1_fig.add_trace(go.Scatter(x=Ex1_best_bids["time"], y=Ex1_best_asks["price"], mode='lines', name='best_asks'))
