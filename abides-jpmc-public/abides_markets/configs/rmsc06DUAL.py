...
# - x     Exchanges
# - x   Value Agents
# - x pro Exchange Market Maker Agents
...
# inter-market spread arbitrage machine
...
def build_config(
    ...
    [
        AdaptiveMarketMakerAgent1(
            id=j,
            name="ADAPTIVE_POV_MARKET_MAKER_AGENT_1_{}".format(j),
            type="AdaptivePOVMarketMakerAgent1",
            symbol=ticker,
            starting_cash=starting_cash,
            pov=MM_PARAMS[idx][1],
            min_order_size=MM_PARAMS[idx][4],
